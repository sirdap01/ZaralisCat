...
<h2 class="section-header">APA KATA MEREKA</h2>

<div class="content-wrapper">
  <div class="empty-state">
    <div class="empty-icon">💬</div>
    <h3>Testimoni Segera Hadir</h3>
    <p>Kami sedang mengumpulkan testimoni dari pelanggan setia kami. Silakan kembali lagi nanti untuk melihat pengalaman mereka!</p>
  </div>
</div>
